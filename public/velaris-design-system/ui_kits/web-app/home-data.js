...
window.VELARIS_LOGOS = [
  {name:"Hazelwood Hearcare", src:"home-img/logo-hazelwood.webp"},
  {name:"Navasana", src:"home-img/logo-navasana.webp"},
  {name:"Core Mechanical Design", src:"home-img/logo-core.webp"},
  {name:"Coastal Crest Lettings", src:"home-img/logo-coastal.webp"},
  {name:"Bellavista Investments", src:"home-img/logo-bellavistra.webp"},
  {name:"Menstruacion", src:"home-img/logo-menstruation.webp"}
];
...
window.VELARIS_TESTIMONIALS = [
  {quote:"I highly recommend Deluar. I just had my logo updated and couldn't be happier with the result. The work was clean, professional, and delivered exactly what I was looking for. Communication was clear throughout, turnaround was fast, and the final product hit the mark on the first pass.",
   stars:5, author:"David Scarborough", role:"Founder, Strategic Marketing (USA)", avatar:"home-img/david.webp", url:""},
  {quote:"Imagine a website that's not performing, only one poorly visible CTA and poorly designed! Well Ahamed is the man for the job — he completely transformed my patient booking system with seamless integration, using advanced design software for each landing page to improve the user experience. Drop him a message for your business!",
   stars:5, author:"Rizwan Makda", role:"Founder, Hazelwood Hearcare (UK)", avatar:"home-img/rizwan.webp", url:"https://www.hazelwoodhearcare.com/"},
  {quote:"Ahamed was great to work with. From start to finish during the project, he was patient and helpful, ensuring that the finished website was exactly what I wanted. He is an exciting designer with fresh ideas, and I would highly recommend him. I would be keen to work with him again.",
   stars:5, author:"Rupert", role:"Business Owner, UK", avatar:"home-img/logo-coastal.webp", avatarLogo:true, url:"https://www.coastalcrestlettings.co.uk/"},
  {quote:"I trusted Ahamed Deluar with my website and he didn't disappoint me — in fact he did a really good job with my website creativibes.co and I'm glad I gave him the job.",
   stars:5, author:"Charaf Zaoudi", role:"CEO &amp; Founder, CREATIVIBE", avatar:"home-img/client-2.webp", url:"https://creativibes.co"},
  {quote:"I highly recommend Ahamed for any role involving UI/UX design, web development or mobile app creation. His ability to blend user-centered design with smart technical execution is outstanding — he has a sharp eye for detail and consistently delivers designs that are both beautiful and functional. A proactive problem-solver, great communicator and a true team player.",
   stars:5, author:"Shafi Uddin", role:"Senior Software QA Engineer (USA)", avatar:"home-img/shafi.webp", url:""}
];

window.VELARIS_CASES = [
  {
    slug:"hazelwood", n:"01", client:"Hazelwood Hearcare", sector:"B2C · Local Healthcare",
    logo:"home-img/logo-hazelwood.webp", logoInvert:false, dark:false, featured:true,
    ...
    img:"home-img/dev-hazelwood.webp", gallery:["home-img/dev-hazelwood.webp","home-img/hazelwood-before-after.webp","home-img/portfolio-hazelwood.webp"], live:"https://www.hazelwoodhearcare.com/",
    pages:[
      {title:"Home", img:"home-img/hazelwood-pages/home-desktop.webp"},
      {title:"About Us", img:"home-img/hazelwood-pages/about-us-desktop.webp"},
      {title:"Locations", img:"home-img/hazelwood-pages/locations-desktop.webp"}
    ],
    ...
    author:"Rizwan Makda", role:"Founder, Hazelwood Hearcare", avatar:"home-img/rizwan.webp"
  },
  {
    slug:"navasana", n:"02", client:"Navasana", sector:"B2B · AI Cyber Insurance",
    logo:"home-img/logo-navasana.webp", logoInvert:true, dark:true, featured:true,
    ...
    img:"home-img/dev-navasana.webp", gallery:["home-img/dev-navasana.webp"], live:"https://www.navasana.ai/",
    pages:[
      {title:"Home", img:"home-img/navasana-pages/home.webp"},
      {title:"Cyber Insurance", img:"home-img/navasana-pages/cyber-insurance.webp"},
      {title:"Broker", img:"home-img/navasana-pages/broker.webp"},
      {title:"Policy Holder", img:"home-img/navasana-pages/policy-holder.webp"},
      {title:"About Us", img:"home-img/navasana-pages/about-us.webp"},
      {title:"Contact & Careers", img:"home-img/navasana-pages/contact-careers.webp"}
    ],
  ...
  },
  {
    ...
    logo:"home-img/logo-core.webp", logoInvert:false, dark:false, featured:true,
    ...
    img:"home-img/dev-core.webp", gallery:["home-img/dev-core.webp","home-img/core-alt.webp"], live:"https://coremech.design/",
    pages:[
      {title:"Home", img:"home-img/core-pages/home.webp"},
      {title:"About Us", img:"home-img/core-pages/about-us.webp"},
      {title:"Our Services", img:"home-img/core-pages/services.webp"},
      {title:"Portfolio", img:"home-img/core-pages/portfolio.webp"},
      {title:"3-Piece Alloy Wheels", img:"home-img/core-pages/portfolio-alloy-wheels.webp"},
      {title:"Blog", img:"home-img/core-pages/blog.webp"},
      {title:"Blog Article", img:"home-img/core-pages/blog-detail.webp"},
      {title:"Contact", img:"home-img/core-pages/contact.webp"}
    ],
  ...
  },
  {
    ...
    logo:"home-img/logo-bellavistra.webp", logoInvert:false, dark:false, featured:false,
    ...
    img:"home-img/dev-bellavista.webp", gallery:["home-img/dev-bellavista.webp"], live:"https://www.bellevistainvestments.com/",
    pages:[
      {title:"Home", img:"home-img/bellavista-pages/home.webp"},
      {title:"Our Services", img:"home-img/bellavista-pages/services.webp"},
      {title:"Real Estate Development", img:"home-img/bellavista-pages/real-estate-development.webp"},
      {title:"Custom Home & Property Design", img:"home-img/bellavista-pages/custom-home-property.webp"},
      {title:"Private Equity Investments", img:"home-img/bellavista-pages/private-equity.webp"},
      {title:"Portfolio", img:"home-img/bellavista-pages/portfolio.webp"}
    ],
  ...
  },
  {
    ...
    logo:"home-img/logo-coastal.webp", logoInvert:false, dark:false, featured:false,
    ...
    img:"home-img/dev-coastal.webp", gallery:["home-img/coastal-pages/home.webp","home-img/coastal-pages/landlords.webp","home-img/coastal-pages/tenants.webp"], live:"https://www.coastalcrestlettings.co.uk/",
    pages:[
      {title:"Home", img:"home-img/coastal-pages/home.webp"},
      {title:"Landlords", img:"home-img/coastal-pages/landlords.webp"},
      {title:"Tenants", img:"home-img/coastal-pages/tenants.webp"}
    ],
    ...
    quote:"Ahamed was great to work with. From start to finish during the project, he was patient and helpful, ensuring that the finished website was exactly what I wanted. He is an exciting designer with fresh ideas, and I would highly recommend him. I would be keen to work with him again.",
    author:"Rupert", role:"Business Owner, UK", avatar:"home-img/logo-coastal.webp", avatarLogo:true
  },
  {
    slug:"menstruation", n:"06", client:"Menstruacion", sector:"B2C · Femtech",
    logo:"home-img/logo-menstruation.webp", logoInvert:false, dark:false, featured:false,
    ...
    img:"home-img/dev-menstruation.webp", gallery:["home-img/menstruation-pages/parents.webp","home-img/menstruation-pages/children.webp","home-img/menstruation-pages/blog.webp"], live:"https://menstruacion.com/",
    pages:[
      {title:"Parent Home", img:"home-img/menstruation-pages/parents.webp"},
      {title:"Children Home", img:"home-img/menstruation-pages/children.webp"},
      {title:"Blog Article", img:"home-img/menstruation-pages/blog.webp"}
    ],
